...
![query 1 result](assets\query1_top10_Data_Analyst_Roles_CompanyName_and_Salary.png)
...
![query 2 chart](assets\query2_chart_salaries_by_skill_data_analyst.png)
...
![query 2 table](assets\query2_table_Company_Skills_Salary.jpg)
...
![query 3 chart](assets\query3_chart_top5_data_analyst_skills.png)
...
![query4 chart](assets\query4_chart_top3_skills_salary.png)
...
![query5 chart1](assets\chart_salary_skills_demand_data_analyst.png)

![query5 chart2](assets\chart2_salary_skills_demand_data_analyst.png)
